            ...
            <div class="bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                <form method="POST" action="">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-l-30 p-r-30" type="text" name="generic_name" placeholder="name" value="{{ $res->name }}">
                    </div>

                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-l-30 p-r-30" type="email" name="generic_name" placeholder="email" value="{{ $res->email }}">
                    </div>

                    <div class="m-b-30 how-pos4-parent" style="display:flex; gap: 20px;">
                        <input class="bor8 stext-111 cl2 plh3 size-116 p-l-30 p-r-30" type="password" name="password" placeholder="Password" value="">
                        <input class="bor8 stext-111 cl2 plh3 size-116 p-l-30 p-r-30" type="password" name="repeat_password" placeholder="Repeat Password" value="">
                    </div>
