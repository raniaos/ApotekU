...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('categories')->insert(['name' => 'ANTIHIPERLIPIDEMIA', 'description'=>'17.8 ANTIHIPERLIPIDEMIA']);
        DB::table('categories')->insert(['name' => 'ANTIFUNGI', 'description'=>'18.3 ANTIFUNGI']);
        DB::table('categories')->insert(['name' => 'ANTIDEPRESi', 'description'=>'23.2 ANTIDEPRESI']);
    }
}
